...
class GiveawaysControllerTest < ActionController::TestCase
  ...
  test "should create giveaway" do
    assert_difference('Giveaway.count') do
      post :create, giveaway: { answer: @giveaway.answer, email: @giveaway.email, name: @giveaway.name, phone: @giveaway.phone }
    end
  ...
  test "should update giveaway" do
    patch :update, id: @giveaway, giveaway: { answer: @giveaway.answer, email: @giveaway.email, name: @giveaway.name, phone: @giveaway.phone }
    assert_redirected_to giveaway_path(assigns(:giveaway))
  end
